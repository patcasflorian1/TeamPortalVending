  ...
  <body>
    ...
    <div class="container mt-3">
        ...
        <div class="row">
            ...
            <h3 class="text-center mb-3" style="color:red;">ProductList</h3>
            ...
            <table class="table mt-4">
              ...
              <tbody class="table-group-divider">
              	...
              	<c:forEach items="${products}" var="str">
                    <tr>
                      <th scope="row">${str.productId}</th>
                      <td>${str.productName}</td>
                      <td>${str.productDescription}</td>
                      <td>${str.productPrice}</td>
