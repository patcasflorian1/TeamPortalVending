  ...
  <body>
	    ...
	    <div class="collapse navbar-collapse" id="navbarScroll">
	      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
	        <li class="nav-item">
	         ...
	         <li class="nav-item">
	          <a class="nav-link active" aria-current="page" href="view-client">ViewClient</a>
	        </li>
	      </ul>
	    </div>
	  </div>
    ...
    <div class="container mt-3">
        ...
        <div class="row">
            ...
            <h3 class="text-center mb-3" style="color:red;">ClientList</h3>
            ...
            <table class="table mt-4">
              ...
              <tbody class="table-group-divider">
              	...
              	<c:forEach items="${clients}" var="str">
                    <tr>
