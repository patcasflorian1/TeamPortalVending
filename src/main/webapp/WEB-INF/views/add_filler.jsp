	...
	<div class="container mt-3">
		<div class="row">
			<div class="col-md-6 offset-md-3">
				...
				<form action="submit-filler" method="post">
					  <div class="mb-3">
					  ...
					  <div class="mb-3">
					    ...
					    <input type="text" name="phoneNumber" class="form-control" placeholder="type phoneNumber">
					  </div>
					   <div class="mb-3">
					    <label class="form-label">Data </label>
					    <input type="text" name="dataEntry" class="form-control" placeholder="type dataEntry">
					  </div>
